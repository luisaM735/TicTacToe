...
$(function () {
    ...
    set = function () {
        ...
        $(this).addClass(turn === "X" ? "x-symbol" : "o-symbol"); // Add class based on current turn
        $(this).css("color", turn === "X" ? "blue" : "red"); 
        ...
        if (win(score[turn])) {
            if(turn === "X"){
                scoreX++;//If X wins, increase score
            } else{
                scoreO++;//If O wins, increase score
            }
    ...
    updateScoreboard = function () {
        $("#scoreX").text(scoreX); // Update X's score
        $("#scoreO").text(scoreO);// Update O's score
    };
